...
$recipientEmail='info@flavorcurp.com.mx	';
$recipientName='FLAVOCURP';
...
$senderSubject = 'Mensaje Flavocurp' . $senderName . $senderEmail;
...
if(!$mail->Send()) {
	...
	echo '<div class="alert alert-success" role="alert">Gracias correo enviado.</div>';
}
?>