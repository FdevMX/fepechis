        ...
        submitHandler: function(contactForm) {
            ...
            $.ajax({
                ...
                success: function(msg) {
                    $(contactResult, contactForm).html('<div class="alert alert-success" role="alert"><strong>Gracias por enviar mensaje</strong></div>').delay(3000).fadeOut(2000); $('.contactForm input,.contactForm textarea').val('');
    ...
    reservationPopupForm.validate({
        ...
        submitHandler: function(reservationPopupForm) {
            ...
            $.ajax({
                ...
                timeout: 20000,
                success: function(msg) {
                    $(reservationResult, reservationPopupForm).html('<div class="alert alert-success" role="alert"><strong>Gracias, te contactarémos pronto.</strong></div>').delay(3000).fadeOut(2000);
                },
                error: $('.thanks').show()
            });
            return false;
    ...
    reservationForm.validate({
        ...
        submitHandler: function(reservationForm) {
            ...
            $.ajax({
                ...
                timeout: 20000,
                success: function(msg) {
                    $(reservationResult, reservationForm).html('<div class="alert alert-success" role="alert"><strong>Gracias, te contactarémos pronto.</strong></div>').delay(3000).fadeOut(2000);
                },
                error: $('.thanks').show()
            });
            return false;
